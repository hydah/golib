...
// TestStdoutLogWriter _
func TestStdoutLogWriter(t *testing.T) {
	console := make(StdoutLogWriter)
...
func TestLogger(t *testing.T) {
	...
	l := make(Logger)
	l.AddFilter("stdout", DEBUG, NewStdoutLogWriter())
...
func TestXMLConfig(t *testing.T) {
	...
	if _, ok := log["stdout"].LogWriter.(StdoutLogWriter); !ok {
		t.Fatalf("XMLConfig: Expected stdout to be StdoutLogWriter, found %T", log["stdout"].LogWriter)
	}
...
// BenchmarkStdoutLog _
func BenchmarkStdoutLog(b *testing.B) {
...
//elog.BenchmarkStdoutLog           100000       22819 ns/op
